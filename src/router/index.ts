    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'system',
          component: () => import('@/components/RouteView.vue'),
          meta: { title: 'layout.menu.system', icon: 'ep:setting', order: 8, menuExpandOnly: true },
          ...
          children: [
            {
              ...
              meta: { title: 'layout.menu.menuManage', icon: 'ep:menu', order: 1 },
            },
            {
              path: 'area',
              name: 'system-area',
              component: () => import('@/views/System/area/index.vue'),
              meta: { title: 'layout.menu.areaManage', icon: 'ep:location', order: 2 },
            },
            {
              path: 'dept',
              name: 'system-dept',
              component: () => import('@/views/System/dept/index.vue'),
              meta: { title: 'layout.menu.deptManage', icon: 'ep:office-building', order: 3 },
            },
            {
              path: 'dict',
              name: 'system-dict',
              component: () => import('@/views/System/dict/index.vue'),
              meta: { title: 'layout.menu.dictManage', icon: 'ep:collection', order: 4 },
            },
            {
              path: 'dict/data/:dictType',
              name: 'system-dict-data',
              component: () => import('@/views/System/dict/data/index.vue'),
              meta: { title: 'layout.menu.dictData', icon: 'ep:document', hidden: true, activeMenu: '/system/dict' },
            },
            {
              path: 'role',
              name: 'system-role',
              component: () => import('@/views/System/role/index.vue'),
              meta: { title: 'layout.menu.roleManage', icon: 'ep:user', order: 5 },
            },
            {
              path: 'user',
              name: 'system-user',
              component: () => import('@/views/System/user/index.vue'),
              meta: { title: 'layout.menu.userManage', icon: 'ep:user-filled', order: 6 },
            },
          ],
        },
      ],
